 ...
 <h2 class="text-md mb-2 px-4 pt-2">
   <div class="flex justify-between">
     <div class="badge relative top-0">
       <span class="mt-2 py-1 h-12px text-md font-semibold   rounded right-1 bottom-1 px-4">{{$station->name}}</span></div>
 ...
 <div class="float-right m-auto">
   ...
   <div class="flex justify-between items-center">
     ...
     <span class="flex space-x-2 items-center">Presión Absoluta : {{$pressureA}}</span>
       ...
       <span class="flex space-x-2 items-center">Sensación términa: {{$feels_like}} ºC</span>
