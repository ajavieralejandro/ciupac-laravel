...
<li class="text-gray-300">
			...
			<li><a class="text-sm text-gray-400 hover:text-gray-500 font-bold" 		href="{{route('welcome').'/#mediciones'}}">
Mediciones</a></li>
...
Contacto</a>
					...
					<li class="mb-1">
						<a class="block p-4 navbar-burger text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" 		href="{{route('welcome').'/#mediciones'}}">
Mediciones</a>
					</li>
				</ul>
			</div>
