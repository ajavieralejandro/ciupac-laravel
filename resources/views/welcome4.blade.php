...
<style>
    <blade font|-face%20%7B>font-family: LucidaGrande;
    ...
    <header>
        <nav class="  px-4 py-4 flex justify-between items-center bg-white shadow-md w-full
            ...
            <ul
                ...
                <li><a class="text-sm text-gray-400 hover:text-gray-500 font-bold"
                        href="{{ route('welcome') }}">
                        Home</a></li>
                ...
                <li><a class="text-sm text-gray-400 font-bold"
                        href="{{ route('welcome').'/#about' }}">Nosotros</a>
                </li>
                <li class="text-gray-300">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor"
                        class="w-4 h-4 current-fill" viewBox="0 0 24 24">
                ...
                <li><a onClick="myFunction()"
                        class="cursor-pointer text-sm text-gray-400 hover:text-gray-500 font-bold">Mediciones</a>
                    <div id="menuMediciones"
                        ...
                        <div class="py-1" role="none">
                            <ul>
                                ...
                                <li> <a href="http://ciupacperfiles.iado-conicet.gob.ar/"
                                        class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1"
                                        id="menu-item-1">Perfiles de Playa</a>
                                </li>
                                <li> <a href="{{ route('estaciones') }}"
                                        class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1"
                                        id="menu-item-2">Estaciones Meteorológicas</a>
                                </li>
                                <li>

                                    <a class="text-gray-700 block px-4 py-2 text-sm" role="menuitem"
                                        href="{{ route('mediciones_basura', ['month' => \Carbon\Carbon::now()->format('m')]) }}">
                                        Mediciones Basura
                                    </a>
                                </li>
                                <li> <a href="http://ciupaccoastsnap.iado-conicet.gob.ar/"
                                        class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1"
                                        id="menu-item-3">CoastSnap</a>
                                </li>
                ...
                <li><a class="text-sm text-gray-400 hover:text-gray-500 font-bold"
                        href="{{ route('welcome').'/#contactsection' }}">
                        Contacto</a></li>
            </ul>
        ...
        <div class="navbar-menu relative z-50 hidden">
            ...
            <nav
                class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-scroll">
                <div class="flex items-center mb-8">
                    <a class="mr-auto text-3xl font-bold leading-none" href="#">
                        <img class="float-right"
                            src="{{ asset('/public/images/ciupac_2.ico') }}" alt="icono" />
                ...
                <div>
                    <ul>
                        <li class="mb-1">
                            <a class="block navbar-burger p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded"
                                href="{{ route('welcome') }}">
                                Home</a>
                        </li>
                        <li class="mb-1">
                        ...
                        <li>
                            <a onClick="showDropdown()" href="#basic-usage"
                                class="block cursor-pointer  p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded">Mediciones
                            </a>
                        </li>
                        <div id="dropdown" class="hidden">
                            ...
                            <li class="ml-4">
                                <a href="{{ route('mediciones_basura', ['month' => \Carbon\Carbon::now()->format('m')]) }}"
                                    class="group flex items-start py-1 hover:text-slate-900">
                                    <svg width="3" height="24" viewBox="0 -9 3 24"
                                        class="mr-2 text-slate-400 overflow-visible group-hover:text-slate-600">
                                        <path d="M0 0L3 3L0 6" fill="none" stroke="currentColor" stroke-width="1.5"
                        ...
                        <li class="mb-1">
                            <a class="block p-4 navbar-burger text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded"
                                href="{{ route('welcome').'/#team' }}">
                                Equipo</a>
                        </li>
                        <li class="mb-1">
