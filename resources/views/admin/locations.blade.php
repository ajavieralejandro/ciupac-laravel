...
<div class="flex flex-col mt-8">
            ...
            <table class="min-w-full">
                ...
                <tbody class="bg-white">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                            <div class="text-sm leading-5 text-gray-500">{{$location->latitude}}</div>
                        </td>

                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                            <div class="text-sm leading-5 text-gray-500">{{$location->longitude}}</div>
                        </td>


                        <td
                            class="px-6 py-4 text-sm leading-5 text-gray-500 whitespace-no-wrap border-b border-gray-200">
                            <a href="{{route('showLocation', ['id' => $location->id]);}}">                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-blue-400" fill="none"
  ...
  <span class="pl-4">Agregar Locacion</span>
</button>
</a>
        </div>
    </div>
