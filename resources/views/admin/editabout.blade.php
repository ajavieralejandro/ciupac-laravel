        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form enctype="multipart/form-data" method="POST" action={{route('storeAbout')}}>
                    @csrf
                    <div class="m-4">
                    <h1>Edita la sección about</h1>
                ...
                <label class="flex flex-col w-full h-32 border-4 border-dashed hover:bg-gray-100 hover:border-gray-300">
                    ...
                    <input onchange="console()" type="file" name="image" id="image" class="opacity-0" />
                        ...
                        <div class="mb-8">
                            ...
                            <textarea name="content" class="border-2 border-gray-500">{{ old('content', $about ? $about->body : '') }}</textarea>
                        </div>
